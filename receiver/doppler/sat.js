...
var timeSinceTleEpochMinutes = 100;
...
//console.log("Freq is:" + dopplerFactor * centerFreq + " Hz");
...
//var tmp = URL.slice((URL.indexOf("freq=") + 5), URL.indexOf(",") );

//URL = URL.replace(tmp, Math.round(dopplerFactor * centerFreq));
//window.location.href = URL;
return (Math.round(dopplerFactor * centerFreq));
}
